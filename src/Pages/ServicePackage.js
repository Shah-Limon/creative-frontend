...
const ServicePackage = () => {
  ...
  useEffect(() => {
    fetch(`http://localhost:5000/service-package/${id}`)
      .then((res) => res.json())
  ...
  return (
    ...
    >
     ...
     <input  class="form-control" type="text" value={p._id} name="packageId"  hidden/>
      <input  class="form-control" type="text" value={p.serviceID} name="serviceID"  hidden/>
